/* ---------- Centralized Contact and Domain Configuration ---------- */
...
export const CONTACT_CONFIG = {
  ...
  // WhatsApp chat link (please format number without '+' or spaces)
  whatsappUrl: "https://wa.me/447517879333",

  // Raw phone/WhatsApp number for links or WhatsApp integrations
